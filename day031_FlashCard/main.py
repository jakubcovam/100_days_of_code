...
- front side of the card reveals a Deutsch word from the 100 most frequent words
- after 3 s, the cad is automatically flipped
...
try:
    ...
    original_data = pd.read_csv("data/deutsch_words_100.csv")
