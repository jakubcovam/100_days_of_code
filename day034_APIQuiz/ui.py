...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, width=280, text="Some question here", font=QUIZ_FONT, fill=THEME_COLOR)
    ...
    def get_next_question(self):
        ...
        if self.quiz.still_has_questions():
            ...
            self.canvas.itemconfig(self.question_text, text=f"Your final score is: {self.quiz.score}/{len(self.quiz.question_list)}")
